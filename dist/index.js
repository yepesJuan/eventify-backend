...
var withAuthorization = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var jwt, id, _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                _b.trys.push([1, 3, , 4]);
                return [4 /*yield*/, firebase_admin_1.default.auth().verifyIdToken(jwt)];
            case 2:
                id = _b.sent();
...
app.get("/authenticated", withAuthorization, function (req, res) {
