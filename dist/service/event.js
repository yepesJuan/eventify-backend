...
var getEvent = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    var col;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, dbConnect_1.getEventCollection)()];
            case 1:
                col = _a.sent();
                return [2 /*return*/, col.findOne({ _id: new mongodb_1.ObjectId(id) })];
        }
    });
}); };
exports.getEvent = getEvent;
var createEvent = function (event) { return __awaiter(void 0, void 0, void 0, function () {
    var col;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, dbConnect_1.getEventCollection)()];
            case 1:
                col = _a.sent();
                return [4 /*yield*/, col.insertOne(event)];
            case 2:
                _a.sent();
                return [2 /*return*/];
        }
...
var deleteEvent = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                col = _a.sent();
                return [4 /*yield*/, col.deleteOne({ _id: new mongodb_1.ObjectId(id) })];
            case 2:
                res = _a.sent();
                console.log(res);
                return [2 /*return*/];
